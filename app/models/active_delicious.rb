class ActiveDelicious < ActiveResource::Base
  class << self
  ...
  ## compliant with Delicious output.
  ...
  ## But, delicious returns the url of this item as id, which we don't want. This method overrides the behavior.
  ...
  ## Modifying the url formation to make it Delicious API complaint
